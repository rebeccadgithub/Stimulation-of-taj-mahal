...
float zoomIncrement = 0.1f;   // Zoom increment value
using namespace std;
...
void drawGrassBackground() {
    ...
    glColor3f(0.498, 1.0, 0.831); // Aquamarine
...
void grass(){
   //glPointSize(5);
    ...
    glColor3f(0.196, 0.804, 0.196); // Lime green
 ...
 // glVertex2f(100.0,250.0);
   ...
   //glColor3f(0.0, 0.392, 0.0); // Dark green
    ...
    glVertex2f(10.89, -0.4);
    glVertex2f(-5.89, -0.4);
     glVertex2f(-5.9, -3.59);
    glVertex2f(10.9, -10.89);
 ...
 glBegin(GL_POLYGON);//ltree
   // glPointSize(5);
    glColor3f(0.0, 0.392, 0.0);
     ...
     glVertex2f(-0.99f, -2.5f);
 
glEnd();


 glBegin(GL_POLYGON);//rtree
   // glPointSize(5);
    glColor3f(0.0, 0.392, 0.0);
     glVertex2f(1.9f, -0.4f);
...
glEnd();
   ...
   glColor3f(0.498, 1.0, 0.831);
     glVertex2f(-0.9f, -0.4f);            
    glVertex2f(1.0f, -0.4f);
glVertex2f(2.9f,-6.0f);               
...
void renderScene() {
    ...
    // Apply zoom
    glTranslatef(0.0f, 0.0f, -zoom);   // Move the camera backward based on zoom level
   
    // Render your Taj Mahal model here
    // ...
